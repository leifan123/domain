...
public enum ExptNum {
	...
	SYSTEM_BUSY(29,"系统繁忙，请稍后重试"),
	SEND_SUCCESS(30, "邮件发送成功，请前往验证！https://mail.qq.com/"),


	ORDER_EXIT(33, "订单已存在"),

	NO_DOMAIN(32, "该域名不存在，或已到期！"),
	FORMATE_ERROR(31, "请检查参数格式是否正确"),

	RESOLVE_INFO_EXIT(34, "解析信息已存在"),
