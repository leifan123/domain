...
public class ApiPermissionControlFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
					if(urlStr.startsWith("/user/getToken.json") || urlStr.startsWith("/user/login.json")  || urlStr.startsWith("/domain/domainFound.json")
							|| urlStr.startsWith("/domain/getDomainName.json") || urlStr.startsWith("/domain/domainFound.json") || urlStr.startsWith("/domain/getSuffix.json")
							|| urlStr.startsWith("/domain/getDomain.json") || urlStr.startsWith("/template/selectTemplates.json")
							|| urlStr.startsWith("/template/createTemple.json") || urlStr.startsWith("/domain/feeDeductionBuy.json")
							|| urlStr.startsWith("/domain/feeDeductionRenevw.json") || urlStr.startsWith("/domain/getRenewPrice.json")){
